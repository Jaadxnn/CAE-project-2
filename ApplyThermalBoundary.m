function [fixedNodes, fixedValues, thermalTipNodes] = ApplyThermalBoundary( ...
    thermalContact, ...
...
%
% Outputs:
%   fixedNodes  -> nodes with prescribed temperature
%   fixedValues -> temperature values
% =========================================================
...
% =========================================================
% 1. CONTACT REGION (HOT TOOL INTERFACE)
% =========================================================
...
elseif bevelled == true
    ...
    if rightcham == true
        ...
        x1r = X_body(2); y1r = Y_body(2);
        x2r = X_body(3); y2r = Y_body(3);
